      ...
      <div class="container-fluid">
		...
		$this->call->view('Users/home', $data); -->
              ...
              <?php if ($data['status'] == "Pending") { ?>
                <a href="<?=site_url('approvevacancy/'.$data['vacancy_id'].'');?>" class="btn btn-primary">Approve</a>

                <a href="<?=site_url('declinevacancy/'.$data['vacancy_id'].'');?>" class="btn btn-primary">Decline</a>
                <?php  } ?>
