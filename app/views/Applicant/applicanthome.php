        ...
        <div class="container-fluid p-0">
            <div class="owl-carousel header-carousel position-relative">
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid myimage" src="<?php echo BASE_URL . PUBLIC_DIR . ('/assets/applicant/img/carousel-1.jpg'); ?>" alt="">
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    ...
                                    <a href="" class="btn btn-blue py-md-3 px-md-5 me-3 animated slideInLeft">Search A Job</a>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="row g-0 about-bg rounded overflow-hidden">
                            <div class="col-6 text-start">
                                <img class="img-fluid w-100" src="<?php echo BASE_URL . PUBLIC_DIR . ('/assets/applicant/img/about-1.jpg'); ?>">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid" src="<?php echo BASE_URL . PUBLIC_DIR . ('/assets/applicant/img/about-2.jpg'); ?>" style="width: 85%; margin-top: 15%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid" src="<?php echo BASE_URL . PUBLIC_DIR . ('/assets/applicant/img/about-3.jpg'); ?>" style="width: 85%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid w-100" src="<?php echo BASE_URL . PUBLIC_DIR . ('/assets/applicant/img/about-4.jpg'); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p><i class="fa fa-check text-blue me-3"></i>Tempor erat elitr rebum at clita</p>
                        <p><i class="fa fa-check text-blue me-3"></i>Aliqu diam amet diam et eos</p>
                        <p><i class="fa fa-check text-blue me-3"></i>Clita duo justo magna dolore erat amet</p>
                        <a class="btn btn-blue py-3 px-5 mt-3" href="">Read More</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <?php endforeach; ?>
                            ...
                            <a class="btn btn-blue py-3 px-5" href="">Browse More Jobs</a>
                        </div>
            ...
            <div class="container">
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item bg-light rounded p-4">
                        <i class="fa fa-quote-left fa-2x text-blue mb-3"></i>
                        <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded" src="<?php echo BASE_URL . PUBLIC_DIR . ('/assets/applicant/img/testimonial-1.jpg'); ?>" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                    ...
                    <div class="testimonial-item bg-light rounded p-4">
                        ...
                        <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded" src="<?php echo BASE_URL . PUBLIC_DIR . ('/assets/applicant/img/testimonial-2.jpg'); ?>" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Client Name</h5>
                                <small>Profession</small>
                            </div>
                    ...
                    <div class="testimonial-item bg-light rounded p-4">
                        ...
                        <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded" src="<?php echo BASE_URL . PUBLIC_DIR . ('/assets/applicant/img/testimonial-3.jpg'); ?>" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Client Name</h5>
                                <small>Profession</small>
                            </div>
                    ...
                    <div class="testimonial-item bg-light rounded p-4">
                        ...
                        <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded" src="<?php echo BASE_URL . PUBLIC_DIR . ('/assets/applicant/img/testimonial-4.jpg'); ?>" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Client Name</h5>
                                <small>Profession</small>
                            </div>
